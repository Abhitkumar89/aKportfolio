...
const Portfolio = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    const serviceId = "service_172wjss";
    const templateId = "template_fj4s7kg";
    const publicKey = "PVTJOIs4x9X4BPxhi";
  ...
  const techStack = [
    ...
    { name: "Cursor", color: "from-purple-600 to-purple-700", icon: "🎯" },
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "An AI-powered blogging platform that offers personalized content recommendations and a sleek user interface.",
      technologies: [
        "React.Js",
        "Node.js",
        "Express.js",
      ...
      liveDemo: "https://fast-blog-gray.vercel.app",
      github: "https://github.com/Abhitkumar89/FastBlog",
    },
    {
      name: "Study-Notion",
      Image:
        "https://img.freepik.com/free-vector/online-learning-isometric-concept_1284-17947.jpg",
      description:
        "A full-featured EdTech platform for online courses, including authentication, payments, and interactive dashboards.",
      technologies: [
        "React.js",
        "Node.js",
        "MongoDB",
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {/* Small Boxes Grid */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto achievement-cards">
              {/* Achievement Cards */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              <motion.div
                ...
                className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 text-center hover:scale-102 transition-all duration-200 group cursor-pointer achievement-card"
                onClick={() =>
                  window.open("https://github.com/Abhitkumar89", "_blank")
                }
              >
                ...
                <div className="text-2xl font-bold text-gray-300 mb-1">10+</div>
